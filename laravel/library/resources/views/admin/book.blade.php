        ...
        <div class="row">
            <div class="col-md-5 offset-md-3">
                <div class="input-group mb-3">
                    <span class="input-group-text" id="basic-addon1"><i class='bx bx-search-alt-2'
                            style="font-size: 1.3rem"></i></box-icon></span>
                ...
                <a href="">
                    <div class="card card-item position-relative" style="width: 18rem;">
                        <div class="card-body" v-on:click.prevent="editData(book.id)">
                            <h5 class="card-title">@{{ book.title }} (@{{ book.qty }}) (@{{ book.publisher_id }})
                            </h5>
                            <h5 class="card-title">@{{ book.catalog_id }} (@{{ book.author_id }})</h5>
                            <p class="card-text">Rp@{{ numberWithSpaces(book.price) }},- </p>
                        </div>
                        <button type="submit" class="btn btn-danger position-absolute btn-delete"
                        ...
                        <form role="form">
                            ...
                            <div class="row g-2 mb-2">
                                <div class="col">
                                    ...
                                    <input type="number" v-model="isbn" id="isbn" name="isbn" class="form-control"
                            ...
                            <div class="row g-2 mb-2">
                                <div class="col mb-0">
                                    ...
                                    <input type="number" v-model="year" id="year" name="year" class="form-control"
                            ...
                            <div class="row mb-2">
                                <div class="col">
                                    ...
                                    <input type="number" v-model="qty" id="qty" name="qty"
                            ...
                            <div class="row mt-2 mb-5">
                                <div class="col">
                                    ...
                                    <input type="number" v-model="price" id="price" name="price"
                                        class="form-control" placeholder="masukkan alamat" />
                                </div>
                            </div>
