                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <form action="{{ url('catalogs', ['id' => $catalog->id]) }}" method="POST"><input class="btn btn-danger btn-sm" type="submit" value="Delete" onclick="return confirm('Apakah kamu yakin?')">
                                    @method('delete')
                                    @csrf
                                </form>
                            </td>
