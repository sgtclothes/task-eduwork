                        ...
                        <div class="card-body">
                            <form action="{{ url('publishers/'.$publisher->id) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('address') is-invalid @enderror" name="address" rows="5" placeholder="Input Address" id="address">{{ old('address', $publisher->address) }}</textarea>
                                    @error('address')
                                    <span class="text-danger">
                                        {{ $message }}
                                    </span>
